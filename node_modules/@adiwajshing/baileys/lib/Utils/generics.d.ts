...
export declare const Browsers: {
    ...
    chrome: (browser: any) => [string, string, string];
    opera: (browser: any) => [string, string, string];
    edge: (browser: any) => [string, string, string];
    firefox: (browser: any) => [string, string, string];
