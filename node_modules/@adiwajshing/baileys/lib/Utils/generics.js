...
exports.Browsers = {
    ...
    chrome: browser => ['Chrome', browser, '122.0.0'],
    opera: browser => ['Opera', browser, '80.3.4244.77596'],
    edge: browser => ['Edge', browser, '122.0.2365.80'],
    firefox: browser => ['Firefox', browser, '123.0'],
    /** The appropriate browser based on your OS & release */
    appropriate: browser => [PLATFORM_MAP[(0, os_1.platform)()] || 'Mac OS', browser, (0, os_1.release)()]
};
exports.BufferJSON = {
    replacer: (k, value) => {
